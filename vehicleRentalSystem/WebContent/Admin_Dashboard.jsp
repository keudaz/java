	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
       ...
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="AddAd.jsp"    >Add Advertisement</a>
        </li>
       <li class="nav-item">
          <a class="nav-link  " href="AddNotifi.jsp"    >Add Notification</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="addVehicle.jsp"    >Add Vehicle</a>
        </li>
       
          <li class="nav-item">
          <a class="nav-link  " href="Maintain.jsp"    >Add Maintain Details</a>
        </li>
           <li class="nav-item">
          <a class="nav-link  " href="Payment.jsp"    >Add Payment detailss</a>
        </li>
